...
import { clearToken, setMyServerURL } from "../features/toots/allTootSlice";
...
try {
 fetchHomeByServer = async (myServerURL, code) => {
    const res = await fetch(`${myServerURL}/api/v1/timelines/home`, {
      headers: {
